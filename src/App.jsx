...
const firebaseConfig = {
  apiKey: "AIzaSyCKHYB7gsGynAR9wByFEHlfF0rcRAymMBM",
  authDomain: "restohire-415e8.firebaseapp.com",
  projectId: "restohire-415e8",
  storageBucket: "restohire-415e8.firebasestorage.app",
  messagingSenderId: "928936979909",
  appId: "1:928936979909:web:81f19f979a490bb26d6fac"
};

const app = initializeApp(firebaseConfig);
const auth = getAuth(app);
const db = getFirestore(app);
const appId = "my-restohire-app"; // Give your app a unique string ID
